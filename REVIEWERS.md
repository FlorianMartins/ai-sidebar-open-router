...
- The submitted package corresponds to the git tag matching its `version`
  (e.g. version `1.23.4` → tag `v1.23.4`).
...
git checkout v1.23.4            # use the tag matching the submitted version
...
- `ai-sidebar-1.23.4-firefox.zip`  (Firefox — built from `manifest.json`)
- `ai-sidebar-chrome-1.23.4.zip`   (Chromium — built from `manifest.chrome.json`)
