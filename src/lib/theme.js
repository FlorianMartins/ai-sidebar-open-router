...
export const THEMES = {
  ...
  dark:   { label: "Default (dark)", bg: "#1f1f34", panel: "#272741", panel2: "#31314f", border: "#3c3c5e", borderSoft: "#2b2b48", text: "#e8e8f2", muted: "#9d9dbb", accent: "#716bf6", accent2: "#3b82f6", accent3: "#a855f7" },
