...
## 1. Corrections appliquées pour la conformité (2.194.0)
...
3. Uploader `ai-sidebar-2.194.0-firefox.zip`.
4. **Code source** : joindre `ai-sidebar-2.194.0-source.zip`. Notre code n'est ni
  ...
  "addons": {
    "ai-sidebar-open-router@github": {
      "updates": [
        {
          "version": "2.194.0",
          "update_link": "https://hivey.be/ai-sidebar-2.194.0.xpi",
...
2. Uploader `ai-sidebar-chrome-2.194.0.zip` (le **zip**, jamais un `.crx`).
